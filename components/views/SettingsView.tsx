  ...
  return (
    <div className="p-12 bg-zinc-50/10 h-full overflow-y-auto">
      <div className="max-w-2xl mx-auto">
        <h2 className="text-3xl font-black text-zinc-800 mb-12">設定</h2>
           ...
           <section>
              ...
              <div className="space-y-6">
                 <div className="flex items-center justify-between p-5 bg-white rounded-2xl border-2 border-zinc-50 shadow-sm">
                    ...
                    <select className="bg-zinc-50 border-2 border-zinc-100 text-xs p-2.5 rounded-xl outline-none font-bold text-zinc-900">
                 ...
                 <div className="flex items-center justify-between p-5 bg-white rounded-2xl border-2 border-zinc-50 shadow-sm">
                    ...
                    <div className="w-12 h-6 bg-zinc-800 rounded-full relative shadow-inner">
           ...
           <section>
              ...
              <div className="space-y-6">
                 <div className="flex items-center justify-between p-5 bg-white rounded-2xl border-2 border-zinc-50 shadow-sm">
                    ...
                    <div className="w-12 h-6 bg-zinc-100 rounded-full relative shadow-inner">
